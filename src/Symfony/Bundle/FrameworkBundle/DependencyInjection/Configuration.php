        ...
        $rootNode
            ...
            ->children()
                ...
                ->booleanNode('set_content_language_from_locale')
                    ...
                    ->defaultFalse()
                ->end()
                ->booleanNode('handle_partial_denormalization_exception')
                    ->info('Whether to convert Exceptions that occurs during Denormalization to Http Bad Request 400 Response.')
                    ->defaultFalse()
                ->end()
                ->booleanNode('handle_validation_failed_exception')
                    ->info('Whether to convert Validation Exceptions to Http Bad Request 400 Response.')
                    ->defaultFalse()
                ->end()
