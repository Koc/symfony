...
class MapRequestInputValueResolverTest extends TestCase
{
    /**
     * @group legacy
     */
    ...
    {
        $resolver = new MapRequestInputValueResolver(
        ...
        $argument = new ArgumentMetadata('dummy', \stdClass::class, false, false, null, false, [
            MapRequestInput::class => new MapRequestInput(),
        ]);
    ...
    public function testValidationNotPassed()
    {
        ...
        $resolver = new MapRequestInputValueResolver($serializer, $validator);
